    ...
    for (int row = 0; row < 25; row++) {
        for (int col = 0; col < 79; col++) {
            ...
            if (letter == '0') {
                ...
                if (s[] == 'D') enemy = new Dragon(d->picture(), (i - 80) % 79, (i - 80) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i - 79) % 79, (i - 79) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i - 78) % 79, (i - 78) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i - 1) % 79, (i - 1) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i + 1) % 79, (i + 1) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i + 78) % 79, (i + 78) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i + 79) % 79, (i + 79) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[] == 'D') enemy = new Dragon(d->picture(), (i + 80) % 79, (i + 80) / 79, static_cast<Dragon_Hoard*>(item));
                d->picture() = enemy;

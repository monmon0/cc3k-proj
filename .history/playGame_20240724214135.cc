    ...
    for (size_t i = 0; i < s.length(); i++) {
        ...
        switch (letter) {
            ...
            case '9':
                ...
                else if (s[i - 78] == 'D') enemy = new Dragon(d->picture(), (i - 78) % 79, (i - 79) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i - 1] == 'D') enemy = new Dragon(d->picture(), (i - 79) % 79, (i - 79) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i + 1] == 'D') enemy = new Dragon(d->picture(), (i - 80) % 79, (i - 80) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i + 78] == 'D') enemy = new Dragon(d->picture(), (i - 80) % 79, (i - 80) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i + 79] == 'D') enemy = new Dragon(d->picture(), (i - 80) % 79, (i - 80) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i + 80] == 'D') enemy = new Dragon(d->picture(), (i - 80) % 79, (i - 80) / 79, static_cast<Dragon_Hoard*>(item));
                d->picture() = enemy;

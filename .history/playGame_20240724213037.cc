    ...
    for (size_t i = 0; i < s.length(); i++) {
        ...
        switch (letter) {
            ...
            case '8': 
                ...
                break;
            case '9':
                item = ItemFactory::createItem(ItemFactory::Type::GOLD_DRAGO, d->picture(), x, y);
                // {
                ...
                //         dx = arr[rand() % 3]; 
                //         dy = arr[rand() % 3]; 
                //         int newX = item->getX() + dx;
                //         int newY = item->getY() + dy; 

                //         if (d->picture()->charAt(newY, newX) == '.') {
                //             x = newX;
                //             y = newY;
                //             break;
                //         }
                ...
                //     enemy = new Dragon(d->picture(), x, y, static_cast<Dragon_Hoard*>(item));
                // }
                break;
            case 'H': 

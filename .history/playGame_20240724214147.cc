    ...
    for (size_t i = 0; i < s.length(); i++) {
        ...
        switch (letter) {
            ...
            case '9':
                ...
                else if (s[i + 78] == 'D') enemy = new Dragon(d->picture(), (i + 1) % 79, (i + 1) / 79, static_cast<Dragon_Hoard*>(item));
                else if (s[i + 79] == 'D') enemy = new Dragon(d->picture(), (i + 1) % 79, (i + 1) / 79, static_cast<Dragon_Hoard*>(item));

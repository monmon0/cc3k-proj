...
class Enemy : public Decorator, public Observer {
    ...
    public:
        Enemy(int xCoord, int yCoord, int hp, int atk, int def) 
            : xCoord{x}, 
        virtual ~Enemy() {}
...
Human::Human(AsciiArt *next, int xCoord, int yCoord, int hp, int atk, int def) 
    : Decorator{next}, xCoord{xCoord}, yCoord{yCoord}, hp{hp}, atk{atk}, def{def} { 

    ...
    for (int row = 0; row < 25; row++) {
        for (int col = 0; col < 79; col++) {
            ...
            if (letter == '0') {
                ...
                Enemy *dp; 
                if (map->charAt(row - 1, col - 1) == 'D') *dp = new Dragon(d->picture(), col - 1, row - 1, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row - 1, col) == 'D') *dp = new Dragon(d->picture(), col, row - 1, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row, col - 1) == 'D') *dp = new Dragon(d->picture(), col - 1, row, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row + 1, col + 1) == 'D') *dp = new Dragon(d->picture(), col + 1, row + 1, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row + 1, col) == 'D') *dp = new Dragon(d->picture(), col, row, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row, col + 1) == 'D') *dp = new Dragon(d->picture(), col, row, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row + 1, col - 1) == 'D') *dp = new Dragon(d->picture(), col, row, static_cast<Dragon_Hoard*>(item));
                else if (map->charAt(row - 1, col + 1) == 'D') *dp = new Dragon(d->picture(), col, row, static_cast<Dragon_Hoard*>(item));

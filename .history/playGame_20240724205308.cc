    ...
    for (int row = 0; row < 25; row++) {
        for (int col = 0; col < 79; col++) {
            ...
            if (letter == '0') {
                ...
                Treausre *treasure = ItemFactory::createItem(ItemFactory::Type::GOLD_NORMAL, d->picture(), r1, r2);
                d->picture() = treasure;
            } else if (name == '7') {
                Treasure *treasure = ItemFactory::createItem(ItemFactory::Type::GOLD_SMALL, d->picture(), r1, r2);
                d->picture() = treasure;
            } else if (name == '8') {
